        ...
        <div class="p-8">
            ...
            <form method="POST" action="#">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="login" id="login" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition" required autofocus>
                </div>
                ...
                <div class="mt-5 text-center">
                    <a href="/register" class="text-sm text-indigo-600 hover:text-indigo-800 hover:underline">Não tem conta? Cadastre-se</a>
                </div>
            </form>
        </div>
    </div>
