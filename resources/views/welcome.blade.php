    ...
    @foreach($events as $event)
        <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition duration-300 overflow-hidden border border-slate-100 flex flex-col h-full">
            <div class="p-6 flex-grow">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-2 line-clamp-2">{{ $event->titulo }}</h3>
                <div class="space-y-2 text-sm text-slate-600 mb-4">
                    ...
                    <div class="flex items-center">
                        ...
                        {{ $event->limite_vagas }} vagas
                    </div>
                </div>
            </div>
            <div class="bg-slate-50 px-6 py-4 border-t border-slate-100">
                <a href="{{ route('events.show', $event->id) }}" class="block w-full text-center bg-white border border-indigo-600 text-indigo-600 hover:bg-indigo-600 hover:text-white font-semibold py-2 rounded-lg transition duration-200">
                    Ver Detalhes
                </a>
            </div>
        </div>
